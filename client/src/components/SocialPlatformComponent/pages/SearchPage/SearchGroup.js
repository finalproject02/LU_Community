                    ...
                    <Card.Text as="div" className="d-flex justify-content-between align-items-center">
                        <div className="d-flex justify-content-start align-items-center pt-3 mb-2">
                            ...
                            <div className="d-flex align-items-center">
                                <h6>
                                    <Link to="#" class="textHover text-dark">Leading University CSE Group</Link>
                                </h6>
                            </div>
                        </div>
                        <Link class="textSecondary text-decoration-none fw-bold">Join</Link>
                    </Card.Text>
                    <Card.Text as="div" className="d-flex justify-content-between align-items-center">
                        <div className="d-flex justify-content-start align-items-center pt-3 mb-2">
                            ...
                            <div className="d-flex align-items-center">
                                <h6>
                                    <Link to="#" class="textHover text-dark">Leading University EEE Group</Link>
                                </h6>
                            </div>
                        </div>
                        <Link class="textSecondary text-decoration-none fw-bold">Join</Link>
