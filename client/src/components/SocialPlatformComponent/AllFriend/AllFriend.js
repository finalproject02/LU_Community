                            ...
                            <Row>
                                {
                                    connections?.map(connection => (
                                        <Col key={connection.id} md="3" className="mb-2">
                                            <Card className="w-100">
                                                <Card.Img src={connection.profile_picture ? `/api/files/storage/${connection.profile_picture}` : Avatar} className="card-img-top rounded-3" alt="..."  onClick={() => {
                                                ...
                                                <Card.Body>
                                                    ...
                                                    <Card.Text as="div" className="mt-2">
                                                        <div className="bgPrimary text-center rounded-3 mb-2">
                                                            <Link className="btn w-100 text-white">Chat</Link>
                                                        </div>
                                                        <div className="bgPrimary text-center rounded-3 mb-2">
                                ...
                                {paramsConnection && (
                                    paramsConnection.map(PConnections => PConnections.map(PConnection => (
                                        <Col key={PConnection.id} md="3" className="mb-2">
                                            <Card className="w-100">
                                                <Card.Img src={PConnection.profile_picture ? `/api/files/storage/${PConnection.profile_picture}` : Avatar} className="card-img-top rounded-3" alt="..."  onClick={() => {
                                                    setPost(true)
