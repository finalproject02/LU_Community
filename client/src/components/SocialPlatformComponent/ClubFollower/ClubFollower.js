                                ...
                                {!showMore && (
                                    paramsClub.slice(0, 4).map(club => club.followers.map(follower => (
                                        <Col md="3" className="mb-2">
                                            <Card className="w-100">
                                                <Card.Img src={getUserProfilePicture(follower) ? `/api/files/storage/${getUserProfilePicture(follower)}` : Avatar} style={{ height: "22vh" }} className="card-img-top rounded-3 cursor" />
                                                <Card.Body>
