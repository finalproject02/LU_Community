                                                    ...
                                                    {firstSemesterCourse.map(first => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${first._id}`} className="textHover text-dark">Course Course Title: {first.course_title} <br /> Course Code: {first.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {secondSemesterCourse.map(second => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${second._id}`} className="textHover text-dark">Course Course Title: {second.course_title} <br /> Course Code: {second.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {thirdSemesterCourse.map(third => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${third._id}`} className="textHover text-dark">Course Course Title: {third.course_title} <br /> Course Code: {third.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {fourthSemesterCourse.map(fourth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${fourth._id}`} className="textHover text-dark">Course Course Title: {fourth.course_title} <br /> Course Code: {fourth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {fifthSemesterCourse.map(fifth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${fifth._id}`} className="textHover text-dark">Course Course Title: {fifth.course_title} <br /> Course Code: {fifth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {sixthSemesterCourse.map(sixth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${sixth._id}`} className="textHover text-dark">Course Course Title: {sixth.course_title} <br /> Course Code: {sixth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {seventhSemesterCourse.map(seventh => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${seventh._id}`} className="textHover text-dark">Course Course Title: {seventh.course_title} <br /> Course Code: {seventh.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {eighthSemesterCourse.map(eighth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${eighth._id}`} className="textHover text-dark">Course Course Title: {eighth.course_title} <br /> Course Code: {eighth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {ninthSemesterCourse.map(ninth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${ninth._id}`} className="textHover text-dark">Course Course Title: {ninth.course_title} <br /> Course Code: {ninth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {tenthSemesterCourse.map(tenth => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${tenth._id}`} className="textHover text-dark">Course Course Title: {tenth.course_title} <br /> Course Code: {tenth.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {elevenSemesterCourse.map(eleven => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${eleven._id}`} className="textHover text-dark">Course Course Title: {eleven.course_title} <br /> Course Code: {eleven.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
                                            ...
                                            <Accordion.Item eventKey="0">
                                                ...
                                                <Accordion.Body>
                                                    {twelveSemesterCourse.map(twelve => (
                                                        <>
                                                            <div className="text-center">
                                                                <Link to={`/assignCourseList/${twelve._id}`} className="textHover text-dark">Course Course Title: {twelve.course_title} <br /> Course Code: {twelve.course_code}</Link>
                                                            </div>
                                                            <hr />
                                                        </>
                                                    ))}
