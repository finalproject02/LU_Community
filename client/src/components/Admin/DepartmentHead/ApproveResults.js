    ...
    return (
        <>
            ...
            <Row className="d-flex justify-content-center mt-5">
                <Col md="8">
                    <h2 className="text-center mb-2 textPrimary">Department of CSE</h2>
                                ...
                                <Accordion.Item eventKey="0">
                                    ...
                                    <Accordion.Body>
                                        <div className="text-center">
                                            <Link to="/approveCourseResults" className="textHover text-dark">Course Course Titel: Introduction To Computer <br /> Course Code: CSE-1111</Link>
                                        </div>
                                        <hr />
                                        <div className="text-center">
