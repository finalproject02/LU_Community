...
export const smsWithReferenceNumber = (name, number, ) => {
    const options = {  'url': `http://66.45.237.70/api.php?username=rezaul123&password=GTH5FXE9&number=${number}&message=${referenceNumberMessage(name, referenceCode)}` };
